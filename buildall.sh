...
sh build.sh
docker push shengqh/bioinfo:java1.8.0_perl5.22.1_r3.6.0

cd /home/shengq2/programs/dockers/r_python3
sh build.sh
docker push shengqh/bioinfo:java1.8.0_perl5.22.1_r3.6.0_python3.7.3
...
sh build.sh
docker push shengqh/bioinfo:java1.8.0_perl5.22.1_r3.6.0_python3.7.3_mono5.20.1.19
...
sh build.sh
docker push shengqh/bioinfo:java1.8.0_perl5.22.1_r3.6.0_python2.7.12
